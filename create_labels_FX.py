...
LABEL_SETTINGS = {
    "short": {
        "base_tf": "M5",
        "lookahead_bars": 12,
        "threshold_factor": 0.33  # ボラティリティ標準偏差の 0.6倍 を売買閾値にする
    },
    "medium": {
        "base_tf": "M15",
        "lookahead_bars": 16,
        "threshold_factor": 0.55 # ボラティリティ標準偏差の 1.0倍 を売買閾値にする
    },
    "long": {
        "base_tf": "H4",
        "lookahead_bars": 30,
        "threshold_factor": 1.25 # ボラティリティ標準偏差の 1.5倍 を売買閾値にする
    }
}
...
def main():
    ...
    for file_path in files:
        ...
        out_file = f"{out_dir}/{filename.replace('_processed', '_labeled_FX')}"
