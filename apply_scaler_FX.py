...
def main():
    ...
    if args.symbol:
        ...
        for sym in target_symbols:
            labeled_path = f"{INPUT_DIR_LABELED}/{sym}_{TARGET_MODE}_labeled_FX.csv"
        ...
        all_files = glob.glob(f"{INPUT_DIR_LABELED}/*_{TARGET_MODE}_labeled_FX.csv")
    ...
    for symbol, features_list in symbol_features_map.items():
        ...
        master_filename = os.path.join(INPUT_DIR_LABELED, f"{symbol}_{TARGET_MODE}_scaled_FX.csv")
